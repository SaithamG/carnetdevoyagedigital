  ...
  <div className="space-y-6 animate-in fade-in duration-500">
    <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-6 rounded-[2rem] border border-slate-800 shadow-xl text-center relative overflow-hidden">
      <div className="relative z-10 flex flex-col justify-center items-center">
        <p className="text-[10px] font-black uppercase tracking-widest text-blue-400 mb-1">
          Budget total estimé du voyage
        </p>
        <p className="text-5xl font-black italic text-white">{totalBudget} €</p>
        <p className="text-xs text-slate-400 mt-3 font-medium max-w-lg">
          Pour 2 voyageurs sur 14 jours. Les postes « avant le départ » sont des estimations à ajuster une fois les
          réservations confirmées ; le budget « sur place » correspond au cash prévu en yens.
        </p>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <BudgetPoche
        ...
        items={budgetData.filter((i) => i.type === 'avant')}
      ...
      <BudgetPoche
        ...
        items={budgetData.filter((i) => i.type === 'place')}
        total={totalSurPlace}
      />
    </div>
