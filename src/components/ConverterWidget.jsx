  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-4 md:bottom-6 right-3 md:right-8 z-50 w-11 h-11 md:w-14 md:h-14 bg-blue-600 hover:bg-blue-500 text-white rounded-full flex items-center justify-center shadow-2xl border border-blue-500 transition-all transform hover:scale-110"
        title="Convertisseur ¥ → €"
      >
        <Calculator size={24} />
      </button>
