...
import { Bell, CalendarPlus, ExternalLink, CheckCircle2, ChevronDown } from 'lucide-react';
    ...
    >
      <div>
        ...
        <button
          ...
          onClick={() => setOpen((o) => !o)}
          aria-expanded={open}
          className={`mb-6 flex items-center gap-1 text-[10px] font-black uppercase tracking-wider ${COLOR_CLASSES[r.color].text400} hover:opacity-80 transition-opacity`}
        >
