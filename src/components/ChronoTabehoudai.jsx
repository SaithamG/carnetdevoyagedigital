  ...
  if (!isOpen) {
    return (
      <button
        ...
        className={`fixed bottom-4 md:bottom-6 left-3 md:left-8 z-50 w-11 h-11 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-2xl border transition-all transform hover:scale-110 ${
          isRunning
