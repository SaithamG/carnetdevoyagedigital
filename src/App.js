...
const App = () => {
  ...
  const reminders = [
    {
      id: 1, title: "Billets TGV INOUI (Aix-Paris A/R)",
    ...
    {
      id: 2, title: "TeamLab Borderless (Tokyo)",
    ...
    {
      id: 4, title: "Restaurant Bœuf de Kobe",
    ...
    {
      id: 5, title: "Train Express Spacia (Nikko)",
    ...
    {
      id: 6, title: "Shibuya Sky (Coucher soleil)",
    ...
    {
      id: 7, title: "Shinkansen Aller (Tokyo ➔ Kyoto)",
    ...
    {
      id: 8, title: "Kansai-Hiroshima Area Pass",
    ...
    {
      id: 9, title: "Shinkansen Retour (Hiroshima ➔ Tokyo)",
    ...
    {
      id: 10, title: "Douane : Visit Japan Web",
