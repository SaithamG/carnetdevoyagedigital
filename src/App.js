...
const App = () => {
  ...
  const runbook = [
    ...
    },
    {
      ...
      desc: 'Mathias : OK. Vérane : Dossier déposé en mairie il y a 1 sem. (en production).',
      status: 'active',
    },
    {
      id: 4,
      title: 'Mise à jour Passagers',
      desc: "Dès réception du passeport de Vérane, l'ajouter dans l'espace client du vol.",
      status: 'pending',
    },
  ];
